...
public class WellWebViewCocoaListener
{
    ...
    [DllImport("WellWebView")]
    private static extern void RegisterOnCloseHandler(MonoPOnCloseDelegate callback);
    ...
    public delegate void MonoPOnCloseDelegate(string ID);
    ...
    [AOT.MonoPInvokeCallback(typeof(MonoPOnCloseDelegate))]
    private static void onClose(string ID)
    {
        webviews[ID].InternalOnClose();
    }
    ...
    public static void RegisterCallbacks()
    {
        ...
        RegisterOnCloseHandler(onClose);
    }
}
